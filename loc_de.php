...
$text_or_in_caps = "ODER";
$text_random_address = "Zufällige Adresse";
...
$text_one_day = "Ein Tag";
$text_two_days = "Zwei Tage";
$text_three_days = "Drei Tage";
$text_one_week = "Eine Woche";
$text_no_limit = "Keine Begrenzung";
...
$text_create_file = "Datei wird angelegt";
$text_file_creation_error = "Kann Datei nicht erstellen";
$text_box_created = "Mailbox wurde angelegt!";
$text_box_exists = "Mailbox existiert bereits!";
$text_invalid_boxname = "Der eingegebene Mailboxname ist ungültig";

$text_db_entry_removed = "Datenbankeintrag erfolgreich entfernt";
$text_db_entry_error = "Fehler bei der Entfernung des Eintrages aus der Datenbank";
$text_file_removed = "Datei erfolgreich entfernt";
$text_file_error = "Fehler beim Entfernen der Datei";
$text_back = "Zurück zum Formular";

$email_subject = "Trashmail entfernt!";
$email_message = "Die folgende mailbox wurde erfolgreich entfernt: ";
?>
